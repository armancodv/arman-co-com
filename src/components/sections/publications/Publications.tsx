...
const Publications: React.FC = () => {
    const publications = useSelector(profileSelectors.getPublications);
    ...
    return (
        <section className="publications">
            ...
            <ul className="publications-container">
                {publications.map((publication) => <PublicationItem key={publication?.id} publication={publication} />)}
            </ul>
        </section>
    )
}
