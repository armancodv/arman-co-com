                ...
                <>
                  ...
                  <div className="profile-contacts">
                    ...
                    <div className="profile-contacts-container">
                      ...
                      <div
                        className="profile-contacts-item profile-contacts-url">
                        <a href={url}>
                    ...
                    <div className="profile-contacts-container">
                      {socials.map((social) => (
                        <div className="profile-contacts-item" key={social?.id}>
                          <a href={social.link}>
                            <FontAwesomeIcon
                              icon={getFontAwesomeIcon(social.icon)}
                              size="lg" color="#477361"/> {social.link}
                          </a>
                        </div>
                      ))}
                    </div>
                  ...
                  <div className="profile-print">
                    <div className="qr-code">
                      <QRCode value={REACT_APP_APP_BASE_URL} size={100}
                        bgColor="transparent" fgColor="#222222"/>
                    </div>
                    <div className="print">
