...
const PortfolioItem: React.FC<PortfolioItemProps> = (props) => {
  return (
    <li>
      <a href={props.portfolio?.link} className="portfolio-item-link"
        target="_blank" rel="noreferrer">
        <article className="portfolio-item">
          <div className="portfolio-item-top">
            <h4 className="portfolio-item-title">
              <FontAwesomeIcon icon={getFontAwesomeIcon(props.portfolio?.icon)}
                className="portfolio-item-title-icon-left"/>
